...
from seo.config import db_option
from seo.background import run_async
from seo.logger import get_logger
from seo.models.base import BaseModelMixin
...
class DatabaseManager:
    ...
    def initialize(self, db_engine: Engine=None, scope_function: Callable = None):
        ...
        # Also I can't just do `from seo.models import *` here, because in py3, the * is only
...
def _package_contents(package_name):
    """
    Given a package name ('seo.models') will return all the modules in that package
...
def import_all_models():
    ...
    """
    for full_module_name in _package_contents('seo.models'):
