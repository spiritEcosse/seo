...
class TestHttpGetAllUnitTestCase:
    @asynctest.patch('seo.models.example.Example.get_all')
    @asynctest.patch('seo.controllers.example_api.transactional_session')
...
class TestHttpGetByIdUnitTestCase:
    @asynctest.patch('seo.models.example.Example.get_by_id')
    @asynctest.patch('seo.controllers.example_api.transactional_session')
